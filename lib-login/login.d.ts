...
declare module qmr {
    /** 创建角色UI */
    class CreateRoleViewUI extends SuperBaseModule {
        imageBg: eui.Image;
        bgGroup: eui.Group;
        modelCon: eui.Group;
        manButton: eui.ToggleButton;
        womanButton: eui.ToggleButton;
        roleName: eui.TextInput;
        btn_enter: eui.Button;
        randomName: eui.Group;
        lbl_time: eui.Label;
        constructor();
    }
}
...
declare module qmr {
    class LoginViewUI extends SuperBaseModule {
        imgBg: eui.Image;
        groupMonkey: eui.Group;
        groupLogin: eui.Group;
        btn_login: eui.Button;
        txt_severmax: eui.Label;
        g_select: eui.Group;
        txt_new: eui.Label;
        txt_severname: eui.Label;
        groupAccount: eui.Group;
        txt_account: eui.TextInput;
        lbl_ver: eui.Label;
        btn_switch: eui.Group;
        constructor();
    }
}
declare module qmr {
...
declare namespace qmr {
    ...
    class LayerManager {
        ...
        private _isHideFight;
        /** 打开模块界面之后把战斗层，功能按钮隐藏/显示 */
        showOrHideFightMapAndToolbar(v: boolean): void;
        /** 是否隐藏了战斗 */
        readonly isHideFight: boolean;
        showLayer(_arg1: string): void;
        hideLayer(_arg1: string): void;
...
declare namespace qmr {
    ...
    class GameLoadManager extends BaseNotify {
        ...
        */
        ...
        private loadLoginBaseAnimation();
        /** 添加预加载资源引用 */
...
declare module qmr {
    ...
    class LoginManager {
        ...
        static showCreateView(): Promise<void>;
    }
}
declare module qmr {
...
declare module qmr {
    class CreateRoleView extends CreateRoleViewUI {
        private avatar;
        private manId;
        private womanId;
        private curId;
